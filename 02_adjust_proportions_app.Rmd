...
-  Two things determine the extent to which we update our beliefs: 
    1) $(SE(\hat{\beta}_s))^2$, a measure of the noise around the trend for a given slice.  
    2) $\tau^2=var(\hat{\beta}_s-\hat{\beta}_{BC})$, a measure of how much slope variation there is *between* the slices.
